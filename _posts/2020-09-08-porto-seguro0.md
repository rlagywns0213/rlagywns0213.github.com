---
title:  "보험상품 고객 데이터 EDA"
excerpt: "보험상품 고객 데이터로 EDA를 통한 인사이트룰 도출하고자 한다. "
categories:
  - Data Analysis
tags:
  - Python
...
## 0\. 들어가며
 ...
 빅데이터 동아리 'boaz'에서 제공받은 신한은행 보험상품 고객 데이터로 EDA를 실시해보았다.
...
import pandas as pd
df = pd.read_csv('보험상품_고객데이터.csv',encoding ='CP949', index_col=0)
